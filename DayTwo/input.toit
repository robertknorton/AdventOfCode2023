input-list-max-cube-per-color := [["red",12],["green",13],["blue",14]]
input-string := """Game 1: 4 green, 3 blue, 11 red; 7 red, 5 green, 10 blue; 3 green, 8 blue, 8 red; 4 red, 12 blue; 15 red, 3 green, 10 blue
