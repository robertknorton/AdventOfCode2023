...
▀▄▄▀▄▄▀▄▄▄▄▀▀▀▀▄▀▀▀▄▄▄▄▄▀▄▄▄▀▀▄▄▀▀▄▄▄▀▀▀▀▄▄▄▄▀▄▄▄▀▀▀▀▀▄▄▄▄▄▀▄▄▄▄▀▄▄▄▄▀▀▄▄▄▄▄▀▀▀▄▄▄▄▀▄▄▄▄▀▄▄▄▄▀▄▄▄▄▀
 ...
 |  __ \              | || |  _   / ____|              | |     | |                     | |    
 | |  | | __ _ _   _  | || |_(_) | (___   ___ _ __ __ _| |_ ___| |__   ___ __ _ _ __ __| |___ 
 | |  | |/ _` | | | | |__   _|    \___ \ / __| '__/ _` | __/ __| '_ \ / __/ _` | '__/ _` / __|
 | |__| | (_| | |_| |    | |  _   ____) | (__| | | (_| | || (__| | | | (_| (_| | | | (_| \__ \
 |_____/ \__,_|\__, |    |_| (_) |_____/ \___|_|  \__,_|\__\___|_| |_|\___\__,_|_|  \__,_|___/
                __/ |                                                                         
               |___/                                                                                                                                         
Luke 1:29-33
...
task-part-one:  
  print "---------PART One---------"
//   list-of-scratch-cards := parse-input-string example-input-string-part1
  list-of-scratch-cards := parse-input-string input-string

  list-of-scratch-cards.do: | card |
    card.points = (score_scratch_card card)
    print card.stringify
    task-part-one-result-sum += card.points
...
class ScratchCard:
  ...
  constructor .number .winning-numbers .card-numbers:

parse_input_string input:
  list-of-scratch-cards := []
  list-of-rows := input.split "\n"
  list-of-rows.do: | row |
    split-colon := row.split ":"
    split-pipe := split-colon.last.split "|"
    // print split-colon
    // print split-pipe
    card := int.parse (split-colon.first.split " ").last
    winning-numbers := split-pipe.first.trim.split " "
    // print winning-numbers
    card-numbers := split-pipe.last.trim.split " "
    card-numbers.remove --all ""
    // print card-numbers
    list-of-scratch-cards.add (ScratchCard card winning-numbers card-numbers)
  return list-of-scratch-cards

score_scratch_card card:
  score := 0
